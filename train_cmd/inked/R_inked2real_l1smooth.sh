...
--loss_type 'l1smooth' --n_epochs 5000 --num_workers 8 \
--init_model_path "inked2real_l1smooth_20181029_213925_unet-ch3_adam_lr0.0001_wd0.0_batch16/checkpoint.pth.tar"